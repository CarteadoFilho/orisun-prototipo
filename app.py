...
# [cite_start]Simulando o CSS do "Dark Mode Acadêmico" (Roxo Profundo e Bege) [cite: 1991]
st.markdown("""
    <style>
    .stApp {
...
# [cite_start]--- NAVEGAÇÃO LATERAL [cite: 1657] ---
with st.sidebar:
    st.image("https://placeholder.com/wp-content/uploads/2018/10/placeholder.com-logo1.png", caption="ORISUN", width=150) # Placeholder para logo
    st.markdown("---")
...
# [cite_start]--- PÁGINA: REGISTRO DE FONTES [cite: 1709] ---
    ...
    with st.form("registro_form"):
        ...
        # [cite_start]Seção 2: Classificação [cite: 1719]
        ...
        # [cite_start]Seção 3: Datação (Com campo texto para EDTF) [cite: 1725]
        ...
        # [cite_start]Seção 4: Preservação [cite: 1732]
        ...
        # [cite_start]Seção 5: Descrição [cite: 1736]
        ...
        tags = st.text_input("Tags (separadas por vírgula)") # Autocomplete seria implementado com lógica extra aqui
        
        # [cite_start]Seção 6: Arquivos [cite: 1746]
...
# [cite_start]--- PÁGINA: ANÁLISE IA [cite: 1761] ---
    ...
    if uploaded_file is not None:
        ...
        with col_form:
            ...
            st.info("Confiança Alta: Título, Data | Confiança Baixa: Autor") # Simulação do Confidence Score
            
            # [cite_start]Formulário pré-preenchido [cite: 1804]
...
# [cite_start]--- PÁGINA: CATÁLOGO [cite: 1835] ---
    ...
    # [cite_start]Toggle Visualização [cite: 1842]
    ...
    if view_mode == "Grade":
        ...
        with col_g1:
            ...
            [cite_start]st.caption("Verificado por IA ✨") # Badge [cite: 1854]
        with col_g2:
